        ...
        <h1><asp:Label ID="label_welcome" runat="server" ForeColor="#3366FF" 
          ...
          <div class="row-fluid">
            <ul class="thumbnails">
              <li class="span3">
                <div class="thumbnail">
                  <img src="img/editprofile.png" alt="product name"/>
                  <div class="caption">
                    <h3>Edit Profile</h3>
                    <p>
                     Customize your profile here. Update your current 
                     email address, phone number and other details.
                    </p>
                  </div>
                  <div class="widget-footer" style="background-color: #C0C0C0 ">
                    <p>
                      <a href="EditProfile.aspx" class="btn btn-primary" style="color: #000000">Edit</a>
                    </p>
                  </div>
                </div>
              </li>
              ...
              <li class="span3">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <p>
                      Check out for your schedule for the day. Hurry up! may be you have 
                      got an event to catch up.. YAYY!
                    </p>
                  </div>
                  <div class="widget-footer" style="background-color: #C0C0C0 ">
                    <p>
                      <a href="Calender.aspx" class="btn btn-primary" style="color: #000000">View</a>
                    </p>
                  </div>
                </div>
              </li>
