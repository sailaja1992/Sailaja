      ...
      <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
          <div class="container" style="background-color: #00FFFF">
            <a href="home.aspx" class="brand brand-bootbus">PlanMyRoute</a>
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                  ...
                  <br>
                    <asp:button runat="server" ID="button1" type="submit" value="Signup" 
                      ...
                      <asp:Image ID="Image1" runat="server" Height="228px" ImageAlign="Right" 
                          ImageUrl="~/img/signupim1.png" Width="219px" />
                  </div>
                </form>
                <h4><i class="icon-question-sign"></i> Existing user? Sign in below:</h4>
