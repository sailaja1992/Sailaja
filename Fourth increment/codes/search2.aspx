      ...
      <div class="container">
        ...
        <tr>
            <td class="style4" style="color:#030000">
               Enter Latitude:</td>
            <td class="style5">
                <asp:TextBox ID="lt" runat="server" Width="185px" 
                    placeholder="Enter latitude"></asp:TextBox>
        ...
        <tr>
            <td class="style4" style="color:#030000">
               Enter Longitude:</td>
            <td class="style5">
                <asp:TextBox ID="ln" runat="server" Width="185px" 
                    placeholder="Enter longitude" ></asp:TextBox>
