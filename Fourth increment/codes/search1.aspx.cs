...
public partial class search1 : System.Web.UI.Page
{
    ...
    protected void button2_Click(object sender, EventArgs e)
    {
        ...
        string address5 = "";
        //1
        string url = String.Format("https://api.foursquare.com/v2/venues/search?client_id=35D45DZIUTWLWAHCPLPNJWRNAMDZMJOGXHFDB0WAKXRGHZMK%20&client_secret=T5LEOKROJDTPAXV35RNFJQCW2ZILMNJFLPT4SJCVUF3DLSCA%20&v=20130815%20&near=" + location + "," + state + "%20&query="+genre+"&limit=5");
        ...
        lat1 = info["response"]["geocode"]["feature"]["geometry"]["center"]["lat"];

        longitute1 = info["response"]["geocode"]["feature"]["geometry"]["center"]["lng"];
        ...
        //2
        string url2 = String.Format("https://api.foursquare.com/v2/venues/search?client_id=35D45DZIUTWLWAHCPLPNJWRNAMDZMJOGXHFDB0WAKXRGHZMK%20&client_secret=T5LEOKROJDTPAXV35RNFJQCW2ZILMNJFLPT4SJCVUF3DLSCA%20&v=20130815%20&near=" + location + "," + state + "%20&query=" + genre + "&limit=5");
        ...
        lat2 = info2["response"]["geocode"]["feature"]["geometry"]["center"]["lat"];

        longitute2 = info2["response"]["geocode"]["feature"]["geometry"]["center"]["lng"];
        ...
        //3
        string url3 = String.Format("https://api.foursquare.com/v2/venues/search?client_id=35D45DZIUTWLWAHCPLPNJWRNAMDZMJOGXHFDB0WAKXRGHZMK%20&client_secret=T5LEOKROJDTPAXV35RNFJQCW2ZILMNJFLPT4SJCVUF3DLSCA%20&v=20130815%20&near=" + location + "," + state + "%20&query=" + genre + "&limit=5");
        ...
        lat3 = info3["response"]["geocode"]["feature"]["geometry"]["center"]["lat"];

        longitute3 = info3["response"]["geocode"]["feature"]["geometry"]["center"]["lng"];
        ...
        //4
        string url4 = String.Format("https://api.foursquare.com/v2/venues/search?client_id=35D45DZIUTWLWAHCPLPNJWRNAMDZMJOGXHFDB0WAKXRGHZMK%20&client_secret=T5LEOKROJDTPAXV35RNFJQCW2ZILMNJFLPT4SJCVUF3DLSCA%20&v=20130815%20&near=" + location + "," + state + "%20&query=" + genre + "&limit=5");
        ...
        lat4 = info4["response"]["geocode"]["feature"]["geometry"]["center"]["lat"];

        longitute4 = info4["response"]["geocode"]["feature"]["geometry"]["center"]["lng"];
        ...
        //5
        string url5 = String.Format("https://api.foursquare.com/v2/venues/search?client_id=35D45DZIUTWLWAHCPLPNJWRNAMDZMJOGXHFDB0WAKXRGHZMK%20&client_secret=T5LEOKROJDTPAXV35RNFJQCW2ZILMNJFLPT4SJCVUF3DLSCA%20&v=20130815%20&near=" + location + "," + state + "%20&query=" + genre + "&limit=5");
        ...
        lat5 = info5["response"]["geocode"]["feature"]["geometry"]["center"]["lat"];

        longitute5 = info5["response"]["geocode"]["feature"]["geometry"]["center"]["lng"];
