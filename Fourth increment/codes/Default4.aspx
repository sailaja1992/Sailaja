...
<html lang="en">
  <head>
    ...
    <title>
      Bootbusiness | Give unique title of the page here
    </title>
    <!-- Bootstrap -->
            ...
            <div class="nav-collapse collapse">
              ...
              <ul class="nav pull-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="our_works.html">
                        Our works
                      </a>
                    </li>
                    <li>
                      <a href="patnerships.html">
                        Parnerships
                      </a>
                    </li>
                    <li>
    ...
    <footer>
      <div class="container">
        <div class="row">
          ...
          <div class="span2">
            <h4>
              <i class="icon-beaker icon-white">
              </i>
              About
            </h4>
            <nav>
              ...
              <div class="span3">
                ...
                <div class="social-icons-row">
                  ...
                  <a href="mailto:soundar.rathinasamy@gmail.com">
                ...
                <div class="social-icons-row">
                  <i class="icon-phone icon-large phone-number">
                  </i>
                  +919750227877
                </div>
              </div>
